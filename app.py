...
def main():
    ...
    if page == "Google Trends with Forecast":
        ...
        st.sidebar.write("## Choose a keyword and a prediction period")
        keyword = st.sidebar.text_input("Keyword", "Amazon")
        periods = st.sidebar.slider("Prediction time in days:", 7, 365, 90)

        st.write("# Welcome to Trend Predictor App")
        st.image(
            "https://media.tenor.com/xfmMlSJRvdoAAAAC/google-voice-search.gif",
            width=350,
        ...
        symbols = [
            "./Audio Files/Meeting 1.mp3",
            "./Audio Files/Meeting 2.mp3",
            "./Audio Files/Meeting 3.mp3",
            "./Audio Files/Meeting 4.mp3",
        ]

        track = st.selectbox("Choose Meeting Audio", symbols)
        st.audio(track)

        ratiodata = st.text_input("Enter summary ratio (e.g. 0.01)")
        ...
        if st.button("Generate Summary"):
            ...
            try:
                ...
                st.warning("Invalid input or missing file.")

    elif page == "Twitter Trends":

        page_title(st, "Social trends", "Twitter sentiment style analysis")

        st.sidebar.write("## Choose keyword and period")
        keyword = st.sidebar.text_input("Keyword", "Amazon")
        periods = st.sidebar.slider("Prediction days:", 7, 365, 90)
        ...
        page_title(st, "Stock forecast", "Historical prices and predictions")
        ...
        ticker = st.sidebar.selectbox("Choose stock", symbols)
        ...
        # (rest logic unchanged - already correct structure in your code)

    elif page == "Live News Sentiment":

        page_title(st, "News sentiment", "Finviz news analysis")
        ...
        if st.button("Fetch News"):
            ...
            def newsfromfizviz(temp):
                pass  # your existing logic stays here
        ...
        page_title(st, "Company profile", "Fundamentals & overview")
